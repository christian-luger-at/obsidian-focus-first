	...
	en: {
		...
		view: {
			...
			detail: {
				...
				note: 'Note',
				why: 'Why here',
				whyOverride: 'Pinned by {tag}, overriding the automatic sort',
				whyUrgent: 'Urgent',
		...
		settings: {
			...
			futureTasks: {
				...
				desc: 'How to treat tasks whose start (🛫) or scheduled (⏳) date is still in the future, so they are not actionable yet. The due date still drives urgency and classification.',
				optionShow: 'Show',
				optionDim: 'Dim',
				optionHide: 'Hide',
			},
	...
	de: {
		...
		settings: {
			...
			futureTasks: {
				...
				desc: 'Wie mit Aufgaben umgegangen wird, deren Startdatum (🛫) oder geplantes Datum (⏳) noch in der Zukunft liegt. Sie sind damit noch nicht bearbeitbar. Das Fälligkeitsdatum bestimmt weiterhin Dringlichkeit und Einordnung.',
				optionShow: 'Anzeigen',
